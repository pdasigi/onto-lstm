...
class Encoder(object):
    ...
    '''
    def __init__(self, data_processor=None, embed_dim=50, bidirectional=False, tune_embedding=False, **kwargs):
        self.embed_dim = embed_dim
        self.data_processor = data_processor
        self.bidirectional = bidirectional
        self.tune_embedding = tune_embedding

    def get_encoded_phrase(self, phrase_input_layer, dropout, embedding):
...
class LSTMEncoder(Encoder):
    @overrides
    def get_encoded_phrase(self, phrase_input_layer, dropout, embedding_file):
